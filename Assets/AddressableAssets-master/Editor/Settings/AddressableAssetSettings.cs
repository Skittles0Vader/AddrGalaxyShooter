    ...
    public partial class AddressableAssetSettings : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        public Hash128 currentHash
        {
            get
            {
                ...
                return HashingMethods.CalculateMD5Hash(stream);
            }
        }
        ...
        public void OnAfterDeserialize()
        {
            m_allEntries.Clear();
            foreach (var g in groups)
                g.OnAfterDeserialize(this, m_allEntries);
        ...
        internal static AddressableAssetSettings GetDefault(bool create, bool browse)
        {
