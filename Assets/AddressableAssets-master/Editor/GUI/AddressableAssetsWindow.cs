            ...
            else
            {
                ...
                switch (currentTab)
                {
                    case (int)TabList.Assets:
                        if (m_groupEditor == null)
                            m_groupEditor = new AddressableAssetsSettingsGroupEditor(settingsObject, this);
                    ...
                    case (int)TabList.Config:
                        if (m_configEditor == null)
                            m_configEditor = new AddressableAssetsSettingsConfigEditor(settingsObject);
                    ...
                    case (int)TabList.Profile:
                        if (m_profileEditor == null)
                            m_profileEditor = new ProfileSettingsEditor(settingsObject);
